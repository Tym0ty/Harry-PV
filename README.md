...
### Key Metrics (Daylight Test Set, n=4,290)

| Metric | Value | Notes |
|--------|-------|-------|
| MAE | 85.7 W/m² | Point forecast (Q50) |
| R² | 0.800 | |
| Mean Pinball Loss | 32.3 | All 19 quantiles |
| PICP80 (q10-q90) | 66.0% | Under-covered (nominal 80%) |
| PICP90 (q05-q95) | 76.7% | Under-covered (nominal 90%) |
| ACE80 | −14.0% | Systematic under-coverage |
| MPIW80 | 251.5 W/m² | |
| Lower tail hit rate (q10) | 11.6% | Close to nominal 10% |

### CQR Calibration Status

The CQR calibration improves lower-quantile calibration (q05-q30 within 2pp of nominal) but **upper quantiles remain systematically under-covered** (q75-q95 deviate 9.6-12.5pp). Critical hours (10-15) show better calibration (PICP80=72.4%) than overall daylight. Sunset hours (17-19) exhibit severe miscalibration. See full audit: `reports/comprehensive_eval/cqr_tail_audit_report.md`.
